...
public class SmartFontGenerator {
	...
	private BitmapFont generateFontWriteFiles(String fontName, FileHandle fontFile, int fontSize, int pageWidth, int pageHeight) {
		...
		parameter.characters = "0123456789endEND";
	...
	public FileHandle getFontFile(String filename, int fontSize) {
		return Gdx.files.internal(generatedFontDir + fontSize + "_" + filename);
	}
